...
const OrdersCards = ( { order } ) => {
    ...
    return (
        <div className="border-2 min-w-96 border-black/20 rounded-lg pt-2 pb-2 pl-3 pr-3 w-full flex gap-2 justify-center items-center relative hover:bg-black/20 transition">
            <div className="flex items-center gap-2">
                <p className="text-sm font-light flex flex-col items-center">
                    ...
                    <span className="text-lg"><b className="font-bold">Artículos:</b> {totalProducts}</span>
